...
import permnotifier.controllers.api.SubscriptionController;
import permnotifier.controllers.api.params.SubscriptionData;
...
public class SubscriptionControllerTest {
	...
	public void should_accept_valid_data() throws Exception {
		...
		MvcResult result = mockMvc.perform(post("/api/subscription")
